      ...
      <div className="container">
        ...
        <div className="row g-4 mb-5">
          ...
          <div className="col-lg-3 col-md-6 col-sm-12">
            <h5 className="fw-bold mb-4" style={{ color: '#ff6b35', fontSize: '1.1rem' }}>
              About Us
            </h5>
            <p style={{ lineHeight: '1.8', fontSize: '0.9rem', color: '#fff' }}>
              Welcome to our restaurant. We serve the finest food with exceptional service and a warm atmosphere that makes every visit memorable.
            </p>
          </div>
          ...
          <div className="col-lg-3 col-md-6 col-sm-12">
            ...
            <ul style={{ listStyle: 'none', padding: 0, fontSize: '0.9rem', color: '#fff', lineHeight: '1.8' }}>
              ...
              <li style={{ marginTop: '10px' }}>
                <span style={{ color: '#ff6b35', fontWeight: 'bold' }}>Closed on Holidays</span>
              </li>
            </ul>
          </div>
          ...
          <div className="col-lg-3 col-md-6 col-sm-12">
            ...
            <ul style={{ listStyle: 'none', padding: 0, fontSize: '0.9rem', color: '#fff', lineHeight: '2' }}>
              <li>
              ...
              <li>
                ...
                <a href="mailto:info@restaurant.com" style={{ color: '#ff6b35', textDecoration: 'none' }}>
                  info@restaurant.com
                </a>
              </li>
            </ul>
